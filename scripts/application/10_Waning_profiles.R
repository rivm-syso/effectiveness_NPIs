...
# - infection_immunity: immediately immune after infection, after plateau start of waning
# - vaccine_immunity: max at two weeks after end primary series, after plateau start of waning
...
# Lancet: ... to 62% (53–69) by 112–139 days (mean 126 days)
...
profile_vaccine_immunity <- as.list(as_tibble(
